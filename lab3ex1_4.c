 ...
 * IR3 2024, subgrupa 3
 * Tema 3 -ex1.4
 * Programul exemplica folosirea functiei execl, si foloseste comanda ls -l din bash ca exemplu
 
 Am tratat urmatoarele edge case-uri:
 -cazul in care execl esueaza, afisez o eroare
...
int main() {
    printf("execut comanda 'ls -l' folosind execl.\n");
    // argumentele sunt date separat
    // primul argument este path ul executabilului pe care il executam, in acest caz '/bin/ls'
    // urmatoarele argumente sunt parametrii pt comanda 'ls'
    // ultimul argument trebuie să fie NULL, pentru a marca sfarsituk listei de argumente
    execl("/bin/ls", "ls", "-l", NULL);

    //in caz ca execl esueaza
...
carina@PCD:~$ gcc lab3ex1_4.c -o lab3ex1_4
carina@PCD:~$ ./lab3ex1_4
execut comanda 'ls -l' folosind execl.
total 448
...
-rw-rw-r-- 1 carina carina   509 Mar 21 17:01 lab3ex1_4.c
